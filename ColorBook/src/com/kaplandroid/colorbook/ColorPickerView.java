...
public class ColorPickerView extends View {
	...
	private static int CENTER_X = 80;
	private static int CENTER_Y = 80;
	...
	private void init() {
		...
		Log.d("Device Height", "" + outMetrics.heightPixels);
		int dHeight = outMetrics.heightPixels;
		if (dHeight <= 320) {
			CENTER_X = 70;
			CENTER_Y = 70;
			CENTER_RADIUS = 25;
	...
	public void setOnColorChangeListener(
			com.kaplandroid.colorbook.Pallete.OnColorChangedListener listner) {
		mListener = listner;
	}
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawOval(getRect(r), mPaint);
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_UP:
			/*
			 * if (mTrackingCenter) { if (inCenter) {} //mTrackingCenter =
			 * false; // so we draw w/o halo invalidate(); }
			 */
